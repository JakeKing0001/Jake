...
TASKS: tuple[Task, ...] = (
    ...
    _t(39, "leggi il tooltip di un bottone", "goal", "accessibility",
       _I + "ToolTipEndToEndTests.test_the_tooltip_is_read_through_full_description"),
    ...
    _t(42, "porta una casella a tre stati su indeterminato", "goal", "checkbox",
       _I + "TristateCheckboxEndToEndTests.test_set_toggle_state_reaches_indeterminate_through_invoke"),
    ...
    _t(69, "spunta una voce di lista con la tastiera", "goal", "checkbox",
       _I + "CheckableListKeyboardEndToEndTests.test_space_on_the_current_item_checks_it_without_coordinates"),
    ...
    _t(94, "spunta la terza voce della lista", "goal", "checkbox",
       _CC + "test_the_third_checkable_item_is_checked_with_the_keyboard"),
